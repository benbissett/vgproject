...
public class JeffController : MonoBehaviour {
    ...
    void TaskOnClick()
    {
        ...
        {
            basicAttack();
            changes.text = "Jeff did " + (10 * strength).ToString() + " damage";
    ...
    void A1OnClick()
    {
        if (turn && ap >= 10)
        {
            ...
            player.startTurn();
            changes.text = "Strength Boost All";
        } 
    }
    ...
    void A2OnClick()
    {
        ...
        {
            a2Attack();
            changes.text = "Jeff did " + (2 * 10 * strength).ToString() + " damage";
    ...
    void UltimateOnClick()
    {
        if (turn && ap >= 50)
        {
            ultimateAttack();
            a1Attack();
            changes.text = "Jeff did " + (100 + 10 * strength).ToString() + " damage + Strength Boost all";
    ...
    {
        raiseStrength();
        player.raiseStrength();
        player.player.raiseStrength();
        player.player.player.raiseStrength();
        turn = false;
    }
        ...
        else
        {
            if (player.getHP() == 0)
            {
                if (player.player.getHP() == 0)
                {
                    canvas.SetActive(false);
                    cam2.SetActive(false);
                    player.player.allyCam.SetActive(true);
                    player.player.allyCanvas.SetActive(true);
                    enemy.startTurn();
                }
                else
                {
